...
// the fix is to make sure to copy the object, otherwise the ref will be a reference from the property
// causing it to mutate at parent component too when changing values here
